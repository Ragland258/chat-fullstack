...
| 项目 | 项目内说明 | 主要内容 |
|---|---|---|
| Qt Client | [client/docs/架构与流程说明](../client/docs/架构与流程说明.md) | 页面关系、HttpMgr、登录会话、WebSocket 和文件客户端目标流程 |
| GateServer | [GateServer/docs/架构与流程说明](../server/GateServer/docs/架构与流程说明.md) | HTTP 网络层、路由、注册登录、MySQL/Redis、gRPC Stub 池 |
| VerifyServer | [VerifyServer/docs/架构与流程说明](../server/VerifyServer/docs/架构与流程说明.md) | 验证码生成、Redis TTL、QQ SMTP、Node.js gRPC |
| StatusServer | [StatusServer/docs/架构与流程说明](../server/StatusServer/docs/架构与流程说明.md) | ChatServer 轮询分配、token 生成、登录 Session |
| ChatServer | [ChatServer/docs/架构与流程说明](../server/ChatServer/docs/架构与流程说明.md) | WebSocket 鉴权、Connection 生命周期、消息路由、上传会话 |
| FileServer | [FileServer/docs/架构与流程说明](../server/FileServer/docs/架构与流程说明.md) | 文件 gRPC、MinIO 预签名 URL、StatObject、CompleteUpload 目标 |
